...
class Plotter(object):
    ...
    """
    def __init__(self, figure, *data): #canvas):
    ...
    def init_axes(self):
        ...
        if n_plots < 4:
            for i in range(n_plots):
                self.fig.add_subplot(1, n_plots, i)

        elif n_plots == 4:
            for i in range(n_plots):
                self.fig.add_subplot(2, 2, i )
        
        elif n_plots > 4:
            for i in range(n_plots):
                self.fig.add_subplot(n_plots/3, 3, i )
    ...
    def pie(self, labels, fracs1,fracs2,group1,group2, title=''):
        ...
        leg1= ax1.legend(P1, labels, loc=loc,ncol=n_cols,fancybox=True)
